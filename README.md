...
- **12** AI Models (Claude Sonnet 4.5, Haiku 4.5, GPT-4o, Llama 4 Scout 17B Vision, CLIP, etc.)
...
- [Category Extraction Qa](https://basilakis.github.io/category-extraction-qa.html)
...
- [Metafield Quick Reference](https://basilakis.github.io/metafield-quick-reference.html)
- [Metafield Workflow Summary](https://basilakis.github.io/metafield-workflow-summary.html)
- [Overview General](https://basilakis.github.io/overview-general.html)
- [Overview](https://basilakis.github.io/overview.html)
- [Pdf Processing Architecture Analysis](https://basilakis.github.io/pdf-processing-architecture-analysis.html)
...
- **PDF Processing**: 14-stage AI pipeline with checkpoint recovery
- **Products + Metadata**: Inseparable extraction with JSONB storage
- **Document Entities**: Certificates, logos, specifications as separate knowledge base
- **Multi-Vector Search**: 6 specialized embeddings for comprehensive search
- **Agentic Queries**: Factory/group filtering for intelligent queries
